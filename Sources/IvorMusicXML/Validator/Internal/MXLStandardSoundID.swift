...
internal enum MXLStandardSoundID {
}

// MARK: -

extension MXLStandardSoundID {

    // MARK: Internal Type Properties

    // Every `<instrument-sound>` value defined by MusicXML 4.0.
    //
    // Generated from `Specifications/schema-4.0/sounds.xml` — 894 identifiers. Regenerate
    // with:
    //
    //     sed -n 's/.*<sound id="\([^"]*\)".*/        "\1",/p' \
    //         Specifications/schema-4.0/sounds.xml | sort
    internal static let all: Set<String> = ["brass.alphorn",
                                            "brass.alto-horn",
                                            "brass.baritone-horn",
                                            "brass.bugle.alto",
