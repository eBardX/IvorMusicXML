...
///
/// Maps the MusicXML `<harmon-mute>` element.
public struct MXLHarmonMute {

    // MARK: Public Initializers

    /// Creates a new `MXLHarmonMute`.
    ///
    /// - Parameter harmonClosed:  Whether the harmon mute is closed, open, or half-open.
    ...
    public init(harmonClosed: MXLHarmonClosed,
        ...
        self.color = color
        self.font = font
        self.harmonClosed = harmonClosed
    ...
    /// Whether the harmon mute is closed, open, or half-open.
    ///
    /// Maps to a nested MusicXML `<harmon-closed>` element.
    public let harmonClosed: MXLHarmonClosed
...
extension MXLHarmonMute: Equatable {
}

// MARK: - Hashable

extension MXLHarmonMute: Hashable {
}

// MARK: - Sendable

extension MXLHarmonMute: Sendable {
}
