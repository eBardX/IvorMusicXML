...
///
/// Maps the MusicXML `<handbell>` element.
public struct MXLHandbell {

    // MARK: Public Initializers

    /// Creates a new `MXLHandbell`.
    ///
...
extension MXLHandbell: Equatable {
}

// MARK: - Hashable

extension MXLHandbell: Hashable {
}

// MARK: - Sendable

extension MXLHandbell: Sendable {
}
