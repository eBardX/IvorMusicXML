...
/// The arrow element represents an arrow used for a musical technical indication. It can represent both Unicode
/// and SMuFL arrows. The presence of an arrowhead element indicates that only the arrowhead is displayed, not the
/// arrow stem. The smufl attribute distinguishes different SMuFL glyphs that have an arrow appearance such as
/// arrowBlackUp, guitarStrumUp, or handbellsSwingUp. The specified glyph should match the descriptive
/// representation.
///
/// Maps the MusicXML `<arrow>` element.
public struct MXLArrow {

    // MARK: Public Initializers

    /// Creates a new `MXLArrow`.
    ///
    /// - Parameter content:    One of the alternatives for Arrow.
...
extension MXLArrow: Equatable {
}

// MARK: - Hashable

extension MXLArrow: Hashable {
}

// MARK: - Sendable

extension MXLArrow: Sendable {
}
