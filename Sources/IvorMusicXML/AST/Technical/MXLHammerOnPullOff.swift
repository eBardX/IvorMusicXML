...
/// The hammer-on and pull-off elements are used in guitar and fretted instrument notation. Since a single slur
/// can be marked over many notes, the hammer-on and pull-off elements are separate so the individual pair of
/// notes can be specified. The element content can be used to specify how the hammer-on or pull-off should be
/// notated. An empty element leaves this choice up to the application.
///
/// Maps the MusicXML `<hammer-on>` and `<pull-off>` elements.
public struct MXLHammerOnPullOff {

    // MARK: Public Initializers

    /// Creates a new `MXLHammerOnPullOff`.
    ///
    /// - Parameter value:      The value of this element.
    /// - Parameter kind:       Whether this is the start or stop of the hammer-on or pull-off.
    ...
    /// Whether this is the start or stop of the hammer-on or pull-off.
    ///
...
extension MXLHammerOnPullOff: Equatable {
}

// MARK: - Hashable

extension MXLHammerOnPullOff: Hashable {
}

// MARK: - Sendable

extension MXLHammerOnPullOff: Sendable {
}
