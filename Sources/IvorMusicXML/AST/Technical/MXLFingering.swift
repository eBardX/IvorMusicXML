...
/// fingerings in the middle of a note. The substitution and alternate values are “no” if the attribute is not
/// present. For guitar and other fretted instruments, the fingering element represents the fretting finger; the
/// pluck element represents the plucking finger.
///
/// Maps the MusicXML `<fingering>` element.
public struct MXLFingering {

    // MARK: Public Initializers

    /// Creates a new `MXLFingering`.
    ///
    /// - Parameter value:         The value of this element.
    /// - Parameter isSubstitute:  A Boolean value indicating whether this fingering is a substitution for another fingering in the middle of a note. `false` if not specified.
    /// - Parameter isAlternate:   A Boolean value indicating whether this is an alternate fingering. `false` if not specified.
    ...
    public init(value: String,
                isSubstitute: Bool? = nil,
                isAlternate: Bool? = nil,
    ...
    /// A Boolean value indicating whether this is an alternate fingering. `false` if not specified.
    ///
    /// Maps to the MusicXML `alternate` attribute.
    public let isAlternate: Bool?

    /// A Boolean value indicating whether this fingering is a substitution for another fingering in the middle of a
    /// note. `false` if not specified.
    ///
    /// Maps to the MusicXML `substitution` attribute.
...
extension MXLFingering: Equatable {
}

// MARK: - Hashable

extension MXLFingering: Hashable {
}

// MARK: - Sendable

extension MXLFingering: Sendable {
}
