...
extension MXLGroupName {
    ...
    public struct Text {
        ...
        /// Creates a new `MXLGroupName.Text`.
        ///
...
extension MXLGroupName.Text: Equatable {
}

// MARK: - Hashable

extension MXLGroupName.Text: Hashable {
}

// MARK: - Sendable

extension MXLGroupName.Text: Sendable {
}
