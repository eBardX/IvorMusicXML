...
/// The group-symbol type indicates how the symbol for a group is indicated in the score. It is none if not
/// specified.
///
/// Maps the MusicXML `<group-symbol>` element.
public struct MXLGroupSymbol {

    // MARK: Public Initializers

    /// Creates a new `MXLGroupSymbol`.
    ///
...
extension MXLGroupSymbol: Equatable {
}

// MARK: - Hashable

extension MXLGroupSymbol: Hashable {
}

// MARK: - Sendable

extension MXLGroupSymbol: Sendable {
}
