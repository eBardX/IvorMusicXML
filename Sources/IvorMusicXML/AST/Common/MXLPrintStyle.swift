...
/// and color.
public struct MXLPrintStyle {

    // MARK: Public Initializers

    /// Creates a new `MXLPrintStyle`.
    ///
...
extension MXLPrintStyle: Equatable {
}

// MARK: - Hashable

extension MXLPrintStyle: Hashable {
}

// MARK: - Sendable

extension MXLPrintStyle: Sendable {
}
