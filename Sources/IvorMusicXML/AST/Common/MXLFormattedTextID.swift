...
///
/// Maps the MusicXML `<credit-words>`, `<rehearsal>`, and `<words>` elements.
public struct MXLFormattedTextID {

    // MARK: Public Initializers

    /// Creates a new `MXLFormattedTextID`.
    ///
...
extension MXLFormattedTextID: Equatable {
}

// MARK: - Hashable

extension MXLFormattedTextID: Hashable {
}

// MARK: - Sendable

extension MXLFormattedTextID: Sendable {
}
