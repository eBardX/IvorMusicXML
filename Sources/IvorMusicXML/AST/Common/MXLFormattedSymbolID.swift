...
///
/// Maps the MusicXML `<credit-symbol>` and `<symbol>` elements.
public struct MXLFormattedSymbolID {

    // MARK: Public Initializers

    /// Creates a new `MXLFormattedSymbolID`.
    ///
...
extension MXLFormattedSymbolID: Equatable {
}

// MARK: - Hashable

extension MXLFormattedSymbolID: Hashable {
}

// MARK: - Sendable

extension MXLFormattedSymbolID: Sendable {
}
