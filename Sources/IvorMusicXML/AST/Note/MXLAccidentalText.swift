...
///
/// Maps the MusicXML `<accidental-text>` element.
public struct MXLAccidentalText {

    // MARK: Public Initializers

    /// Creates a new `MXLAccidentalText`.
    ///
...
extension MXLAccidentalText: Equatable {
}

// MARK: - Hashable

extension MXLAccidentalText: Hashable {
}

// MARK: - Sendable

extension MXLAccidentalText: Sendable {
}
