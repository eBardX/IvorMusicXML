...
/// The principal-voice type represents principal and secondary voices in a score, either for analysis or for
/// square bracket symbols that appear in a score. The element content is used for analysis and may be any text
/// value. The symbol attribute indicates the type of symbol used. When used for analysis separate from any
/// printed score markings, it should be set to none. Otherwise if the type is stop it should be set to plain.
///
/// Maps the MusicXML `<principal-voice>` element.
public struct MXLPrincipalVoice {

    // MARK: Public Initializers

    /// Creates a new `MXLPrincipalVoice`.
    ///
    ...
    /// - Parameter kind: Whether this element marks the start or the stop of the principal voice marking.
    /// - Parameter symbol: The type of symbol used to indicate the principal or secondary voice.
    ...
    /// Whether this element marks the start or the stop of the principal voice marking.
    ///
    ...
    /// The type of symbol used to indicate the principal or secondary voice.
    ///
...
extension MXLPrincipalVoice: Equatable {
}

// MARK: - Hashable

extension MXLPrincipalVoice: Hashable {
}

// MARK: - Sendable

extension MXLPrincipalVoice: Sendable {
}
