...
/// The harp-pedals type is used to create harp pedal diagrams. The pedal-step and pedal-alter elements use the
...
///
/// Maps the MusicXML `<harp-pedals>` element.
public struct MXLHarpPedals {

    // MARK: Public Initializers

    /// Creates a new `MXLHarpPedals`.
    ///
    ...
    /// - Parameter pedalTuning:  The tuning for each pedal in the harp pedal diagram.
    ...
    /// The tuning for each pedal in the harp pedal diagram.
    ///
    /// Maps to nested MusicXML `<pedal-tuning>` elements.
    public let pedalTuning: [MXLPedalTuning]
...
extension MXLHarpPedals: Equatable {
}

// MARK: - Hashable

extension MXLHarpPedals: Hashable {
}

// MARK: - Sendable

extension MXLHarpPedals: Sendable {
}
