...
///
/// Maps the MusicXML `<segno>` element.
public struct MXLSegno {

    // MARK: Public Initializers

    /// Creates a new `MXLSegno`.
    ///
    ...
    /// - Parameter smufl: Specifies the exact segno glyph to use.
    public init(id: String? = nil,
                ...
                smufl: MXLSmuflSegnoGlyphName? = nil) {
        self.color = color
        self.font = font
        self.halign = halign
        self.id = id
    ...
    /// Specifies the exact segno glyph to use.
    ///
    /// Maps to the MusicXML `smufl` attribute.
    public let smufl: MXLSmuflSegnoGlyphName?
...
extension MXLSegno: Equatable {
}

// MARK: - Hashable

extension MXLSegno: Hashable {
}

// MARK: - Sendable

extension MXLSegno: Sendable {
}
