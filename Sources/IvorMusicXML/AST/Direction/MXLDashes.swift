...
///
/// Maps the MusicXML `<dashes>` element.
public struct MXLDashes {

    // MARK: Public Initializers

    /// Creates a new `MXLDashes`.
    ///
    ...
    /// - Parameter kind:  Whether this is the start, stop, or continuation of the dashes.
    /// - Parameter number:  Distinguishes this set of dashes from other dashes that might be active at the same time.
    ...
    /// Whether this is the start, stop, or continuation of the dashes.
    ///
    /// Maps to the MusicXML `type` attribute.
    public let kind: MXLStartStopContinue

    /// Distinguishes this set of dashes from other dashes that might be active at the same time.
    ///
...
extension MXLDashes: Equatable {
}

// MARK: - Hashable

extension MXLDashes: Hashable {
}

// MARK: - Sendable

extension MXLDashes: Sendable {
}
