...
/// The coda type is the visual indicator of a coda sign. The exact glyph can be specified with the smufl
/// attribute. A sound element is also needed to guide playback applications reliably.
///
/// Maps the MusicXML `<coda>` element.
public struct MXLCoda {

    // MARK: Public Initializers

    /// Creates a new `MXLCoda`.
    ///
    ...
    /// - Parameter smufl:  The SMuFL canonical glyph name used to specify a particular coda character.
    public init(id: String? = nil,
                ...
                smufl: MXLSmuflCodaGlyphName? = nil) {
        self.color = color
        self.font = font
        self.halign = halign
        self.id = id
    ...
    /// The SMuFL canonical glyph name used to specify a particular coda character.
    ///
    /// Maps to the MusicXML `smufl` attribute.
    public let smufl: MXLSmuflCodaGlyphName?
...
extension MXLCoda: Equatable {
}

// MARK: - Hashable

extension MXLCoda: Hashable {
}

// MARK: - Sendable

extension MXLCoda: Sendable {
}
