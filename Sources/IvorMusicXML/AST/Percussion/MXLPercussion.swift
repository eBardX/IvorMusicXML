...
/// The percussion element is used to define percussion pictogram symbols. Definitions for these symbols can be
/// found in Kurt Stone’s “Music Notation in the Twentieth Century” on pages 206-212 and 223. Some values are
/// added to these based on how usage has evolved in the 30 years since Stone’s book was published.
///
/// Maps the MusicXML `<percussion>` element.
public struct MXLPercussion {

    // MARK: Public Initializers

    /// Creates a new `MXLPercussion`.
    ///
    ...
    /// - Parameter content: One of the alternatives for Percussion.
...
extension MXLPercussion: Equatable {
}

// MARK: - Hashable

extension MXLPercussion: Hashable {
}

// MARK: - Sendable

extension MXLPercussion: Sendable {
}
