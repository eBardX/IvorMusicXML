...
/// The inversion type represents harmony inversions. The value is a number indicating which inversion is used: 0
/// for root position, 1 for first inversion, etc. The text attribute indicates how the inversion should be
/// displayed in a score.
///
/// Maps the MusicXML `<inversion>` element.
public struct MXLInversion {

    // MARK: Public Initializers

    /// Creates a new `MXLInversion`.
    ///
    /// - Parameter value: The value of this element.
    /// - Parameter text: Indicates how the inversion should be displayed in a score.
...
extension MXLInversion: Equatable {
}

// MARK: - Hashable

extension MXLInversion: Hashable {
}

// MARK: - Sendable

extension MXLInversion: Sendable {
}
