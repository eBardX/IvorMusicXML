...
/// The harmony-alter type represents the chromatic alteration of the root, numeral, or bass of the current
/// harmony-chord group within the harmony element. In some chord styles, the text of the preceding element may
/// include alteration information. In that case, the print-object attribute of this type can be set to no. The
/// location attribute indicates whether the alteration should appear to the left or the right of the preceding
/// element. Its default value varies by element.
///
/// Maps the MusicXML `<bass-alter>`, `<numeral-alter>`, and `<root-alter>` elements.
public struct MXLHarmonyAlter {

    // MARK: Public Initializers

    /// Creates a new `MXLHarmonyAlter`.
    ///
    ...
    /// - Parameter location: Indicates whether the alteration should appear to the left or the right of the preceding element.
    ...
    /// Indicates whether the alteration should appear to the left or the right of the preceding element.
    ///
...
extension MXLHarmonyAlter: Equatable {
}

// MARK: - Hashable

extension MXLHarmonyAlter: Hashable {
}

// MARK: - Sendable

extension MXLHarmonyAlter: Sendable {
}
