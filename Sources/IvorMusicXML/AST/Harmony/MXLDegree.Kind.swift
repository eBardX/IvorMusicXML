...
extension MXLDegree {
    ...
    /// The degree-type type indicates if this degree is an addition, alteration, or subtraction relative to the kind
    /// of the current chord. The value of the degree-type element affects the interpretation of the value of the
    /// degree-alter element. The text attribute specifies how the type of the degree should be displayed.
    ///
    /// Maps the MusicXML `<degree-type>` element.
    public struct Kind {

        // MARK: Public Initializers

        /// Creates a new `MXLDegree.Kind`.
        ///
        /// - Parameter value: The value of this element.
        /// - Parameter text:  Specifies how the type of the degree should be displayed.
...
extension MXLDegree.Kind: Equatable {
}

// MARK: - Hashable

extension MXLDegree.Kind: Hashable {
}

// MARK: - Sendable

extension MXLDegree.Kind: Sendable {
}
