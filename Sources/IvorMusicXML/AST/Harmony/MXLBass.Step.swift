...
extension MXLBass {
    ...
    /// The bass-step type represents the pitch step of the bass of the current chord within the harmony element. The
    /// text attribute indicates how the bass should appear in a score if not using the element contents.
    ///
    /// Maps the MusicXML `<bass-step>` element.
    public struct Step {

        // MARK: Public Initializers

        /// Creates a new `MXLBass.Step`.
        ///
        /// - Parameter value: The value of this element.
        /// - Parameter text:  Indicates how the bass should appear in a score if not using the element contents.
...
extension MXLBass.Step: Equatable {
}

// MARK: - Hashable

extension MXLBass.Step: Hashable {
}

// MARK: - Sendable

extension MXLBass.Step: Sendable {
}
