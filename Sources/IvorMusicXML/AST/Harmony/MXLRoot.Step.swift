...
extension MXLRoot {
    ...
    /// The root-step type represents the pitch step of the root of the current chord within the harmony element. The
    /// text attribute indicates how the root should appear in a score if not using the element contents.
    ///
    /// Maps the MusicXML `<root-step>` element.
    public struct Step {

        // MARK: Public Initializers

        /// Creates a new `MXLRoot.Step`.
        ///
        /// - Parameter value: The value of this element.
        /// - Parameter text: Indicates how the root should appear in the score, if not using the element contents.
        ...
        /// Indicates how the root should appear in the score, if not using the element contents.
        ///
        /// Maps to the MusicXML `text` attribute.
        public let text: String?

        /// The value of this element.
        public let value: MXLStep
    }
}

// MARK: - Equatable

extension MXLRoot.Step: Equatable {
}

// MARK: - Hashable

extension MXLRoot.Step: Hashable {
}

// MARK: - Sendable

extension MXLRoot.Step: Sendable {
}
