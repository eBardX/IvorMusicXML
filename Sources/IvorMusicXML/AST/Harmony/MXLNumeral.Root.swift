...
extension MXLNumeral {
    ...
    /// The numeral-root type represents the Roman numeral or Nashville number as a positive integer from 1 to 7. The
    /// text attribute indicates how the numeral should appear in the score. A numeral-root value of 5 with a kind of
    /// major would have a text attribute of “V” if displayed as a Roman numeral, and “5” if displayed as a Nashville
    /// number. If the text attribute is not specified, the display is application-dependent.
    ///
    /// Maps the MusicXML `<numeral-root>` element.
    public struct Root {

        // MARK: Public Initializers

        /// Creates a new `MXLNumeral.Root`.
        ///
        /// - Parameter value: The value of this element.
        /// - Parameter text: Indicates how the numeral should appear in the score. If not specified, the display is application-dependent.
        ...
        /// Indicates how the numeral should appear in the score. If not specified, the display is
...
extension MXLNumeral.Root: Equatable {
}

// MARK: - Hashable

extension MXLNumeral.Root: Hashable {
}

// MARK: - Sendable

extension MXLNumeral.Root: Sendable {
}
