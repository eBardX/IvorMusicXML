...
/// The staff-divide element represents the staff division arrow symbols found at SMuFL code points U+E00B,
/// U+E00C, and U+E00D.
///
/// Maps the MusicXML `<staff-divide>` element.
public struct MXLStaffDivide {

    // MARK: Public Initializers

    /// Creates a new `MXLStaffDivide`.
    ///
    ...
    /// - Parameter kind: The symbol used to represent the staff division.
    ...
    /// The symbol used to represent the staff division.
    ///
    /// Maps to the MusicXML `type` attribute.
    public let kind: Symbol
...
extension MXLStaffDivide: Equatable {
}

// MARK: - Hashable

extension MXLStaffDivide: Hashable {
}

// MARK: - Sendable

extension MXLStaffDivide: Sendable {
}
