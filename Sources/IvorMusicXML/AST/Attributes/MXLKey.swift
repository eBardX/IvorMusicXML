...
/// the part. Key signatures appear at the start of each system unless the print-object attribute has been set to
/// “no”.
///
/// Maps the MusicXML `<key>` element.
public struct MXLKey {

    // MARK: Public Initializers

    /// Creates a new `MXLKey`.
    ///
    ...
    /// - Parameter content: One of the alternatives for Key.
    /// - Parameter octave: The optional list of key-octave elements is used to specify in which octave each element of the key signature appears.
    /// - Parameter number: The staff number that this element applies to. If absent, the key signature applies to all staves in the part.
    ...
    /// The staff number that this element applies to. If absent, the key signature applies to all staves in the part.
    ///
    /// Maps to the MusicXML `number` attribute.
    public let number: MXLStaffNumber?

    /// The optional list of key-octave elements is used to specify in which octave each element of the key signature
    /// appears.
    ///
    /// Maps to a nested MusicXML `<key-octave>` element.
...
extension MXLKey: Equatable {
}

// MARK: - Hashable

extension MXLKey: Hashable {
}

// MARK: - Sendable

extension MXLKey: Sendable {
}
