...
extension MXLAttributes {
    ...
    ///
    /// Maps the MusicXML `<directive>` element.
    public struct Directive {

        // MARK: Public Initializers

        /// Creates a new `MXLAttributes.Directive`.
        ///
...
extension MXLAttributes.Directive: Equatable {
}

// MARK: - Hashable

extension MXLAttributes.Directive: Hashable {
}

// MARK: - Sendable

extension MXLAttributes.Directive: Sendable {
}
