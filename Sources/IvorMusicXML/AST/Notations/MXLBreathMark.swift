...
///
/// Maps the MusicXML `<breath-mark>` element.
public struct MXLBreathMark {

    // MARK: Public Initializers

    /// Creates a new `MXLBreathMark`.
    ///
...
extension MXLBreathMark: Equatable {
}

// MARK: - Hashable

extension MXLBreathMark: Hashable {
}

// MARK: - Sendable

extension MXLBreathMark: Sendable {
}
