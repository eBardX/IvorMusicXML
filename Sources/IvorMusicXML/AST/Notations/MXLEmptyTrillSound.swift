...
/// The empty-trill-sound type represents an empty element with print-style, placement, and trill-sound
/// attributes.
///
/// Maps the MusicXML `<haydn>`, `<inverted-vertical-turn>`, `<shake>`, `<trill-mark>`, and `<vertical-turn>`
/// elements.
public struct MXLEmptyTrillSound {

    // MARK: Public Initializers

    /// Creates a new `MXLEmptyTrillSound`.
    ///
...
extension MXLEmptyTrillSound: Equatable {
}

// MARK: - Hashable

extension MXLEmptyTrillSound: Hashable {
}

// MARK: - Sendable

extension MXLEmptyTrillSound: Sendable {
}
