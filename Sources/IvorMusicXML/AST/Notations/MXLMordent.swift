...
/// The mordent type represents both the mordent sign with the vertical line and the inverted-mordent sign without
/// the line. The long attribute is "no" by default. The approach and departure attributes are used for compound
/// ornaments, indicating how the beginning and ending of the ornament look relative to the main part of the
/// mordent.
///
/// Maps the MusicXML `<inverted-mordent>` and `<mordent>` elements.
public struct MXLMordent {

    // MARK: Public Initializers

    /// Creates a new `MXLMordent`.
    ///
    ...
    /// - Parameter isLong: A Boolean value indicating whether this is a long mordent or inverted-mordent sign. Defaults to `false` if not specified.
    /// - Parameter approach: The approach and departure attributes are used for compound ornaments, indicating how the beginning and ending of the ornament look relative to the main part of the mordent.
    /// - Parameter departure: The approach and departure attributes are used for compound ornaments, indicating how the beginning and ending of the ornament look relative to the main part of the mordent.
    public init(position: MXLPosition = MXLPosition(),
                ...
                isLong: Bool? = nil,
                approach: MXLAboveBelow? = nil,
                departure: MXLAboveBelow? = nil) {
        self.approach = approach
        self.color = color
        self.departure = departure
        self.font = font
        self.isLong = isLong ?? false
    ...
    /// The approach and departure attributes are used for compound ornaments, indicating how the beginning and
    /// ending of the ornament look relative to the main part of the mordent.
    ///
    /// Maps to the MusicXML `approach` attribute.
    public let approach: MXLAboveBelow?
    ...
    /// ending of the ornament look relative to the main part of the mordent.
    ///
    /// Maps to the MusicXML `departure` attribute.
    public let departure: MXLAboveBelow?
    ...
    /// A Boolean value indicating whether this is a long mordent or inverted-mordent sign. Defaults to `false` if
    /// not specified.
    ///
    /// Maps to the MusicXML `long` attribute.
...
extension MXLMordent: Equatable {
}

// MARK: - Hashable

extension MXLMordent: Hashable {
}

// MARK: - Sendable

extension MXLMordent: Sendable {
}
