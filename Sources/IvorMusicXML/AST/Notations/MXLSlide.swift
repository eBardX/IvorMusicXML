...
/// are not discerned. A slide is continuous between the two pitches and defaults to a solid line. The optional
/// text for a slide is printed alongside the line.
///
/// Maps the MusicXML `<slide>` element.
public struct MXLSlide {

    // MARK: Public Initializers

    /// Creates a new `MXLSlide`.
    ///
    ...
    /// - Parameter kind: Whether this element marks the start or the stop of the slide.
    ...
    public init(id: String? = nil,
                ...
                color: MXLColor? = nil,
                bendSound: MXLBendSound = MXLBendSound()) {
    ...
    public let bendSound: MXLBendSound
    ...
    /// Whether this element marks the start or the stop of the slide.
    ///
...
extension MXLSlide: Equatable {
}

// MARK: - Hashable

extension MXLSlide: Hashable {
}

// MARK: - Sendable

extension MXLSlide: Sendable {
}
