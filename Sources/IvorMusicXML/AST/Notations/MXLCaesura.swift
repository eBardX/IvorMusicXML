...
/// The caesura element indicates a slight pause. It is notated using a “railroad tracks” symbol or other
/// variations specified in the element content.
///
/// Maps the MusicXML `<caesura>` element.
public struct MXLCaesura {

    // MARK: Public Initializers

    /// Creates a new `MXLCaesura`.
    ///
...
extension MXLCaesura: Equatable {
}

// MARK: - Hashable

extension MXLCaesura: Hashable {
}

// MARK: - Sendable

extension MXLCaesura: Sendable {
}
