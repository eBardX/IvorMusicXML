...
/// An accidental-mark can be used as a separate notation or as part of an ornament. When used in an ornament,
/// position and placement are relative to the ornament, not relative to the note.
///
/// Maps the MusicXML `<accidental-mark>` element.
public struct MXLAccidentalMark {

    // MARK: Public Initializers

    /// Creates a new `MXLAccidentalMark`.
    ///
...
extension MXLAccidentalMark: Equatable {
}

// MARK: - Hashable

extension MXLAccidentalMark: Hashable {
}

// MARK: - Sendable

extension MXLAccidentalMark: Sendable {
}
