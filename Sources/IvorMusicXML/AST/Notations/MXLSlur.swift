...
/// Slur types are empty. Most slurs are represented with two elements: one with a start type, and one with a stop
/// type. Slurs can add more elements using a continue type. This is typically used to specify the formatting of
/// cross-system slurs, or to specify the shape of very complex slurs.
///
/// Maps the MusicXML `<slur>` element.
public struct MXLSlur {

    // MARK: Public Initializers

    /// Creates a new `MXLSlur`.
    ///
    ...
    /// - Parameter kind: Whether this element marks the start, stop, or continuation of the slur.
    ...
    /// Whether this element marks the start, stop, or continuation of the slur.
    ///
...
extension MXLSlur: Equatable {
}

// MARK: - Hashable

extension MXLSlur: Hashable {
}

// MARK: - Sendable

extension MXLSlur: Sendable {
}
