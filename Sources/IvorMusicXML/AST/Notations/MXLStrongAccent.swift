...
///
/// Maps the MusicXML `<strong-accent>` element.
public struct MXLStrongAccent {

    // MARK: Public Initializers

    /// Creates a new `MXLStrongAccent`.
    ///
...
extension MXLStrongAccent: Equatable {
}

// MARK: - Hashable

extension MXLStrongAccent: Hashable {
}

// MARK: - Sendable

extension MXLStrongAccent: Sendable {
}
