...
struct MXLFormattedTextTests {
}

// MARK: -

extension MXLFormattedTextTests {
    @Test
    func equality() {
        #expect(MXLFormattedText(value: "Allegro") == MXLFormattedText(value: "Allegro"))    // swiftlint:disable:this identical_operands
    }

    @Test
    func hashable() {
        let values: Set<MXLFormattedText> = [MXLFormattedText(value: "Allegro"),
                                             MXLFormattedText(value: "Allegro"),
                                             MXLFormattedText(value: "Adagio")]
    ...
    @Test
    func inequality() {
        #expect(MXLFormattedText(value: "Allegro") != MXLFormattedText(value: "Adagio"))
    }

    @Test
    func init_defaultValues() {
        let value = MXLFormattedText(value: "Allegro")
